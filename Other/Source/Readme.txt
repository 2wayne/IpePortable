...
user in an INI file next to IpePortable.exe called IpePortable.ini.
...
copy AppNamePortable.ini from this directory to IpePortable.ini next to
IpePortable.exe. The options in the INI file are as follows:
